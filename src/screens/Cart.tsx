...
const Cart = ({ route, navigation }) => {
  ...
  useEffect(() => {
    if (price1) {
      ...
      if (!isNaN(numericPrice)) {
        const total = numericPrice + 9.99;
        setPriceGg(total);
        console.log("Total Price:", total);
      } else {
        console.error("Invalid price format:", price1);
      }
    }
  }, [price1]);
  ...
  useEffect(() => {
    const getItem = async () => {
      try {
        setPrice1(cart[0].price);
        setImage(cart[0].product_image);
        setName(cart[0].product_name);
        setSize(cart[0].size);
        console.log(price1);
        console.log(size);
        console.log(name);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.section}>
        <View style={styles.row}>
          ...
          <Text style={styles.productPrice}>{price1}.00</Text>
        </View>
      ...
      <View style={styles.section}>
        <View style={styles.row}>
          ...
          <Text style={styles.subtotalPrice}>{price1}.00</Text>
        </View>
        <View style={styles.row}>
