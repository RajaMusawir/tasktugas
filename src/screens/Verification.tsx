...
const Verification = ({ navigation, route }) => {
    ...
    const {phoneNumber1} = route.params;
    console.log(phoneNumber1)
    const phoneNumber = (`+92${phoneNumber1}`)
    ...
    return (
        ...
        <TouchableOpacity style={styles.cameraButton} onPress={() => navigation.navigate('Login')}>
          <Image source={require('./../../assets/back.png')} style={styles.close_style} />
            ...
            <Text style={styles.text_tagline}>Hey! Please select one of the options below to verify</Text>
            <Text style={styles.text_tagline1}>your account</Text>
